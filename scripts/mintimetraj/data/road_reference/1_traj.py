...
plotter.plotReference(0, path_to_ref_center, color=CL['BLU'], interval=1)
plotter.plotOptXY(0, 3, ref_center, '-', legend_loc='upper right')
plotter.ax[0].set(xlim=[30,70], ylim=[-40, -5])
plt.savefig(os.path.join(os.path.abspath(os.path.dirname(__file__)), 'Trajectory optimized with center reference.svg'))
...
plotter.plotTrack(0, path_to_track)
plotter.plotReference(0, path_to_ref_right, color=CL['BLU'], interval=1)
plotter.plotOptXY(0, 3, ref_right, '-', legend_loc='upper right')
plotter.ax[0].set(xlim=[30,70], ylim=[-40, -5])
plt.savefig(os.path.join(os.path.abspath(os.path.dirname(__file__)), 'Trajectory optimized with right reference.svg'))
