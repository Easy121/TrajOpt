...
Use free optimization for road reference, with dense points at the start (50m) and sparse points afterwards
"""
...
#     os.path.dirname(__file__)), 'data/' + 'reference_7dof_2' + '.yaml')
